package com.webidias.cryptoapp.adapter
...
import com.webidias.cryptoapp.databinding.TopCurrencyLayoutBinding
import com.webidias.cryptoapp.models.CryptoCurrency
...
class TopMarketAdapter(var context: Context, val list: List<CryptoCurrency>): RecyclerView.Adapter<TopMarketAdapter.TopMarketViewHolder>() {
    ...
    override fun onBindViewHolder(holder: TopMarketViewHolder, position: Int) {
        ...
        Glide.with(context).load("https://s2.coinmarketcap.com/static/img/coins/64x64/" + imageID + ".png")
    }
